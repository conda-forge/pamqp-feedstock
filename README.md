...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pamqp-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7106&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pamqp-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pamqp` can be installed with:

```
conda install pamqp
```

It is possible to list all of the versions of `pamqp` available on your platform with:
